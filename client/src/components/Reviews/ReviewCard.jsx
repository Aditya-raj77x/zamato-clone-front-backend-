...
const ReviewCard = (props) => {
    const [user, setUser] = useState("Aditya_Raj");
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-full">
                        <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWDnuGTrl3gZf3B_9hL3C0eWGQFkpv_t8Yow&usqp=CAU"
                            alt="Son_Goku"
                ...
                <button className="text-zomato-400 border border-zomato-600 y-2 rounded-lg px-4 hover:bg-zomato-200">
                    Follow
                </button>
            </div>
